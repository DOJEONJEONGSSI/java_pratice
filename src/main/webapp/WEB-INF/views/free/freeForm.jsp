...
<script
	src="${pageContext.request.contextPath }/resources/smarteditor2-2.8.2.3/js/HuskyEZCreator.js"></script>
</head>
<body>
	<%@ include file="/WEB-INF/inc/top.jsp"%>
	<section class="page-section" id="contact">
		<div class="container" style="margin-top: 100px;">
			<form action="freeBoardWriteDo" method="post"
				onsubmit="return fn_check()">
				<table class="table table-striped table-bordered">
					<tr>
						<th>제목</th>
						<td><input name="boTitle" class="form-control input-sm"
							type="text" required="required"></td>
					</tr>
					<tr>
						<th>작성자</th>
						<td><input name="boWriter" class="form-control input-sm"
							type="text" required="required"></td>
					</tr>
					<tr>
						<th>비밀번호</th>
						<td><input name="boPass" class="form-control input-sm"
					...
					<tr>
						<th>내용</th>
						<td><textarea name="boContent" id="bo_content"
