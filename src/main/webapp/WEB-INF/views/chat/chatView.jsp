						...
						<div id="list-guestbook" class="">
							<c:forEach items="${chatList }" var="chat">
								...
								<c:if test="${sessionScope.login.memId eq chat.memId }">
									<ul>
										<li data-no="" class="me pr-2"><strong class="">${chat.memId }(${chat.memNm })</strong>
											<img src="${chat.profileImg }" id="myImage"
											class="rounded-circle img-thumbnail shadow-sm" width="60"
								...
								<c:if test="${sessionScope.login.memId ne chat.memId }">
									<ul>
										<li data-no="" class="pl-2"><strong>${chat.memId }(${chat.memNm })</strong>
