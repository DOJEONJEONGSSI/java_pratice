				...
				<div class="chatWrap">
					...
					<div class="content chatcontent border border-secondary"
						...
						<div id="list-guestbook" class="">
							<!-- 내 채팅일 경우 -->
							<ul>
								<li data-no="" class="me pr-2"><strong class="">내
										이름</strong>
									<div class="me">
										<p class='myChat chat-box text-left p-3'>메세지 ^^</p>
										<strong style="display: inline;" class="align-self-end">2024-10-14
											14:20:05</strong>
									</div></li>
							</ul>
							<!-- 다른사람의 채팅일 경우 -->
							<ul>
								<li data-no="" class="pl-2"><strong>다른 사람 이름</strong>
									<div>
										<p class='chat-box bg-light p-3'>메세지 ^_____^</p>
										<strong style="display: inline;" class="align-self-center">2024-10-14
											14:20:05</strong>
									</div></li>
							</ul>
						</div>
					...
					<div>
						<div class="d-flex justify-content-center" style="height: 60px">
							...
							<button type="button" id="btnSend" class="send btn btn-primary"
								style="width: 25%; height: 100%">보내기</button>
							<button type="button" id="btnOut" class="btn btn-secondary "
								style="width: 25%; height: 100%">나가기</button>
						</div>
					</div>
				</div>
			</div>
		...
		$(document).ready(
				function() {
					...
					client.connect({
						...
						client.subscribe("/subscribe/chat/" + roomNo, function(
								chat) {
